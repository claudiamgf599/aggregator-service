package com.trade.aggregator.config;
...
public class ServiceClientsConfig {
    ...
    @Bean
    public StockServiceCliente stockServiceClient(@Value("${stock.service.url}") String baseUrl) {
        return new StockServiceCliente(createWebClient(baseUrl));
    }
