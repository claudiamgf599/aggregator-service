package com.trade.aggregator.service;

import com.trade.aggregator.client.CustomerServiceClient;
import com.trade.aggregator.client.StockServiceCliente;
import com.trade.aggregator.dto.*;
...
public class CustomerPortfolioService {
    ...
    public CustomerPortfolioService(StockServiceCliente stockServiceCliente, CustomerServiceClient customerServiceClient) {
    ...
    public Mono<StockTradeResponse> trade(Integer customerId, TradeRequest request) {
        return this.stockServiceCliente.getStockPrice(request.ticker())
